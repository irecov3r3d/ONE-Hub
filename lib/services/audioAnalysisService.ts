...
export class AudioAnalysisService {
   ...
   * ⚡ Bolt Optimization: Uses integrated AdvancedKeyDetection with spectral reuse.
   */
  private async analyzeMusicalFeatures(
    ...
    const pitchClasses = this.analyzePitchClassesFromChroma(keyData.chromagram, audioBuffer.sampleRate);
   ...
   * ⚡ Bolt Optimization: Uses pre-calculated chromagram from AdvancedKeyDetection.
   */
   ...
   * @deprecated Use analyzePitchClassesFromChroma for better performance.
   */
  private analyzePitchClasses(_samples: Float32Array, _sampleRate: number): PitchClass[] {
    return this.analyzePitchClassesFromChroma(new Array(12).fill(0), _sampleRate);
  }
