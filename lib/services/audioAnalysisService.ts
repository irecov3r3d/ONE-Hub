...
export class AudioAnalysisService {
   ...
   * ⚡ Bolt Optimization: Uses real AdvancedKeyDetection with pre-calculated magnitudes.
   */
  private async analyzeMusicalFeatures(
    ...
    const keyData = await this.keyDetector.detectKey(linearMagnitudes, audioBuffer.sampleRate, true);
