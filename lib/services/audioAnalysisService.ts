...
export class AudioAnalysisService {
   ...
   * ⚡ Bolt Optimization: Uses real Krumhansl-Schmuckler key detection via AdvancedKeyDetection.
   * Reuses pre-calculated magnitudes8192 to eliminate redundant FFT passes.
   */
  private async analyzeMusicalFeatures(
    ...
    const keyData = await this.keyDetector.detectKey(magnitudes8192, audioBuffer.sampleRate);
