...
export class AudioAnalysisService {
  ...
  private async analyzeMusicalFeatures(
    ...
    // ⚡ Bolt: Use optimized key detector with pre-calculated spectral magnitudes
    const keyData = magnitudes8192
      ? this.keyDetector.detectKeyFromMagnitudes(magnitudes8192, audioBuffer.sampleRate)
      : await this.keyDetector.detectKey(audioBuffer);
