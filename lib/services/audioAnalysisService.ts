...
export class AudioAnalysisService {
   ...
   * ⚡ Bolt Optimization: Uses pre-calculated 8192-point magnitudes for key detection.
   */
  private async analyzeMusicalFeatures(
    ...
    const keyData = this.keyDetector.detectKeyFromMagnitudes(magnitudes8192, audioBuffer.sampleRate, 8192);
