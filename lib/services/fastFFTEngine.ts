...
export class FastFFTEngine {
   ...
   * ⚡ Bolt Optimization:
   * 1. Supports polymorphic input (AudioBuffer or raw samples).
  ...
  async performFFT(
    ...
    if (input instanceof Float32Array) {
      ...
      // Use middle portion for AudioBuffer analysis
    ...
    // ⚡ Bolt: Ensure we don't exceed fftSize if input is larger
