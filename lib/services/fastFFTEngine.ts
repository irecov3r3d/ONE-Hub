...
export class FastFFTEngine {
   ...
   * ⚡ Bolt Optimization:
   * 1. Support for polymorphic input (AudioBuffer or raw Float32Array) for zero-copy sub-segment analysis.
  ...
  async performFFT(
    ...
    if (input instanceof Float32Array) {
      ...
      // Use middle portion for AudioBuffer if no specific subarray is provided
