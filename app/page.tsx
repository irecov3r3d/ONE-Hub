  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-950 via-black to-blue-950 text-white">
      <header className="border-b border-white/10 bg-black/40 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-5 sm:py-6 flex flex-col gap-5 sm:gap-6">
          ...
          <div className="grid gap-3 sm:flex sm:flex-wrap sm:items-center">
            <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:items-center">
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-sm"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-10 grid gap-6 lg:grid-cols-[1.5fr_1fr]">
            ...
            <div className="space-y-3">
              {timelineSlots.map((track, index) =>
                track ? (
                  <div
                    key={track.id}
                    className="flex flex-col gap-3 rounded-xl border border-white/10 bg-black/30 p-3 sm:flex-row sm:flex-wrap sm:items-center"
                  >
